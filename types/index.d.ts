...
type WithoutExtraProperties<BaseType, Arg extends BaseType> = Arg &
  Neverify<Omit<Arg, keyof BaseType>>;

type ComputedFormProperty<
  T extends FormMethodOptions,
...
type FormMethodResult<
  T extends FormMethodOptions,
  K extends keyof T = keyof T
> = string extends T[K]
  ?
      | ComputedFormProperty<
          T,
          'headers',
          string,
          Record<string, string> | undefined
        >
      | ComputedFormProperty<T, 'payload', string, Readable | undefined>
  : ComputedFormProperty<T, 'headers', 'headers', Record<string, string>> &
      ComputedFormProperty<T, 'payload', 'payload', Readable>;
...
export default function formMethod<
  T extends FormMethodOptions = FormMethodDefaultOptions
>(
